---
title: "11S Comparison Stage 18 vs 30"
author: "LeAnn Lo"
...
```{r}
#choose the files
files <- c(files_selfie_11_st18, files_selfie_11_st30)

# combine sample names
sampNum <- c(sampNum_1811Selfie, sampNum_3011Selfie)
...
plot(project.pca$x, type="n", main="11S st18 vs st30 PCA Plot", xlab=paste("PC1, ", round(project.pca.proportionvariances[1], 2), "%"), ylab=paste("PC2, ", round(project.pca.proportionvariances[2], 2), "%"))
...
hist(res$pvalue, main = "St18 11S vs St30 11S", xlab = "p-values", col = "lavender")
summary(res)
#counts_deseq = (exp(counts_deseq) - 1)
writeOutput(res, dds, "st18_st30", c("11S", "11S"), dir, counts_deseq)
```
