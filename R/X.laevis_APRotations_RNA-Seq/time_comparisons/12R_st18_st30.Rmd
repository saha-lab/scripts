---
title: "12R Comparison Stage 18 vs 30"
author: "LeAnn Lo"
...
```{r}
#choose the files
files <- c(files_apr_12R_st18, files_apr_12R_st30)

# combine sample names
sampNum <- c(sampNum_1812R, sampNum_3012R)
...
plot(project.pca$x, type="n", main="12R st18 vs st30 PCA Plot", xlab=paste("PC1, ", round(project.pca.proportionvariances[1], 2), "%"), ylab=paste("PC2, ", round(project.pca.proportionvariances[2], 2), "%"))
...
hist(res$pvalue, main = "St18 12R vs St30 12R", xlab = "p-values", col = "lavender")
summary(res)
#counts_deseq = (exp(counts_deseq) - 1)
writeOutput(res, dds, "st18_st30", c("12R", "12R"), dir, counts_deseq)
```
