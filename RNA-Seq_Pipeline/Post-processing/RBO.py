...
def main( argv1, argv2 ):
    ...
    with open( argv1, 'r' ) as file1:
        reader1 = pandas.read_csv(file1)
        list1 = list(reader1['gene'])
    with open( argv2, 'r' ) as file2:
        reader2 = pandas.read_csv(file2)
        list2 = list(reader2['gene'])
    print score(list1, list2, p = 0.95)
