...
"""
In progress, takes two gene lists from the output of shared_finder in csv format and outputs the shared genes between the lists in a new csv file for a "comparison of comparison"
