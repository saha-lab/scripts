...
NOTE: If the script fails to run, check if your input files have "gene" or "Gene" at the first cell
Update lines 27 and 30 to match your file.
...
def unique_finder(file1reader, file2reader):
	...
	try:
		...
		list1 = file1reader['Gene']

	try:
		list2 = file2reader['gene'] # put all the genes into a list, ordered by padj
	except:
