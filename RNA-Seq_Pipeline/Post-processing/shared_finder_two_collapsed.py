...
"""
Takes two gene list in csv format and outputs the shared genes between the lists in a new csv file
Include the rank of the gene in its parent list, log2FoldChange and padj 
Modified for collapsed homeolog shared list with gene descriptions column
...
def shared_finder(file1reader, file2reader):
	...
	list1 = []
	list1 = file1reader[file1reader.columns[0]] # put all the genes into a list, make sure these genes are ranked by padj
...
if __name__ == "__main__":
	...
	if data is not None:
		...
		print slice_name(fName1) + "_" + slice_name(fName2) + "_shared_results.csv"
