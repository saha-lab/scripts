...
# encoding: utf-8
"""
Takes paired-end read fastq files, and concatenates them into a single fasta file.

USAGE: interleave_fastq_to_fasta.py [-h] [--rm-short-reads RM_SHORT_READS] [LEFT_INPUT] [RIGHT_INPUT] [INTERLEAVED_OUTPUT]
