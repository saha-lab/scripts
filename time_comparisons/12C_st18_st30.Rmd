---
title: "12C Comparison Stage 18 vs 30"
author: "LeAnn Lo"
...
```{r}
#choose the files
files <- c(files_apr_12C_st18, files_apr_12C_st30)

# combine sample names
sampNum <- c(sampNum_1812C, sampNum_3012C)
...
plot(project.pca$x, type="n", main="12C st18 vs st30 PCA Plot", xlab=paste("PC1, ", round(project.pca.proportionvariances[1], 2), "%"), ylab=paste("PC2, ", round(project.pca.proportionvariances[2], 2), "%"))
...
hist(res$pvalue, main = "St18 12C vs St30 12C", xlab = "p-values", col = "lavender")
summary(res)
#counts_deseq = (exp(counts_deseq) - 1)
writeOutput(res, dds, "st18_st30", c("12C", "12C"), dir, counts_deseq)
```
