---
title: "11R Comparison Stage 18 vs 30"
author: "LeAnn Lo"
...
```{r}
#choose the files
files <- c(files_apr_11R_st18, files_apr_11R_st30)

# combine sample names
sampNum <- c(sampNum_1811R, sampNum_3011R)
...
plot(project.pca$x, type="n", main="11R st18 vs st30 PCA Plot", xlab=paste("PC1, ", round(project.pca.proportionvariances[1], 2), "%"), ylab=paste("PC2, ", round(project.pca.proportionvariances[2], 2), "%"))
...
hist(res$pvalue, main = "St18 11R vs St30 11R", xlab = "p-values", col = "lavender")
summary(res)
#counts_deseq = (exp(counts_deseq) - 1)
writeOutput(res, dds, "st18_st30", c("11R", "11R"), dir, counts_deseq)
```
